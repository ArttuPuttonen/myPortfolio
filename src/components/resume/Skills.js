        ...
        <div>
            ...
            >
                ...
                <div className="w-full lgl:w-1/2 flex flex-col justify-between">
                    ...
                    <div className="w-full flex-grow mt-14 flex flex-col gap-6">
                        {/* Skill Bars */}
                        {[
                ...
                <div className="w-full lgl:w-1/2 flex flex-col justify-between">
                    ...
                    <div className="w-full flex-grow mt-14 grid grid-cols-2 gap-6">
                        {/* Static Skills / Certifications */}
                        {[
                            ...
                            <div key={index} className="bg-gradient-to-r from-blue-600 to-pink-500 p-4 rounded-md shadow-lg flex items-center justify-between">
                                <div>
