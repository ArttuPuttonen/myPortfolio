...
const ResumeCard = ({title, des, subTitle, result}) => {
    return (
        <div className="w-full h-1/3 group flex">
            ...
            rounded-lg px-10 flex flex-col justify-center gap-10 shadow-shadowOne"> 
                <div className="flex justify-between items-center">
                    ...
                    <p className="text-sm mt-2 text-grey-400 group-hover:text-white duration-300">
                        {subTitle}
                    </p>
                    </div>
                    <div>
                ...
                <p className="font-medium text-gray-400 group-hover:text-gray-300 duration-300">
                    {des}
                </p>
            </div>
        </div>
